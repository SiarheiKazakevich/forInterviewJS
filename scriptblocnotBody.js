function createBlocnotBody() {
  try {
    ...
    let qaPairs = [
      ...
      {
        question:
          "Вопрос 1.69: Расскажите о типе данных Symbol и его практическом применении.",
      ...
      {
        question: "Вопрос 1.70: Что такое V8 Engine?",
      ...
      {
        question: "Вопрос 1.71: Что такое Event loop и как он работает?",
      ...
      {
        question: "Вопрос 1.72:Что означает аббревиатура CORS?",
      ...
      {
        question: "Вопрос 1.73: Что такое XSS",
      ...
      {
        question:
          "Вопрос 1.74: В чем разница между императивным и декларативным программированием?",
        answer: `Императивное программирование — это описание того, как ты делаешь что-то, а декларативное — того, что ты делаешь.`,
      },
      {
        question: "Вопрос 1.75: Что такое SPA?",
      ...
      {
        question:
          "Вопрос 1.76: Что такое Объектно-ориентированное программирование и функциональное программирование?",
